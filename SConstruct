...
env.Append(CPPPATH=["plugin/", "headers/", "C:/Program Files (x86)/Windows Kits/10/Include/", "C:/Program Files (x86)/Windows Kits/10/Source/"])
env.Append(LIBPATH=["C:/Program Files (x86)/Windows Kits/10/Lib/"])
...
# env.Append(LIBPATH=['plugin/bin/WS2_32.Lib'])
